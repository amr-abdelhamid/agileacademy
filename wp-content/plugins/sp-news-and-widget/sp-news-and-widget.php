...
?>
            <h3 class="widgettitle title"><?php echo $title ?> - <small><a href="http://www.agileacademy.co/news/" target="_blank">see all</a></small></h3>
            <!--visual-columns-->
            ...
            if ($cust_loop->have_posts()) : while ($cust_loop->have_posts()) : $cust_loop->the_post(); $postcount++;
                    ?>
                    <li>
                        <small><a class="post-title" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></small>
...
?>
		<h3 class="widgettitle title"><?php echo $title ?> - <small><a href="http://www.agileacademy.co/news/" target="_blank">see all</a></small></h3>          <!--visual-columns-->
            <div class="recent-news-items">
