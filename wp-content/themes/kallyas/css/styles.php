...
h1 , .page-title{
	...
	<?php
		if( isset ( $data['h1_typo']['style'] ) ){
			switch ($data['h1_typo']['style']) {
				case 'normal':
...
h2 {
	...
	<?php
		if( isset ( $data['h2_typo']['style'] ) ){
			switch ($data['h2_typo']['style']) {
				case 'normal':
					echo 'font-weight:normal;';
				break;
				case 'italic':
...
h3 {
	...
	<?php
		if( isset ( $data['h3_typo']['style'] ) ){
			switch ($data['h3_typo']['style']) {
				case 'normal':
					echo 'font-weight:normal;';
				break;
				case 'italic':
...
h4 {
	...
	<?php
		if( isset ( $data['h4_typo']['style'] ) ){
			switch ($data['h4_typo']['style']) {
				case 'normal':
					echo 'font-weight:normal;';
				break;
				case 'italic':
...
h5 {
	...
	<?php
		if( isset ( $data['h5_typo']['style'] ) ){
			switch ($data['h5_typo']['style']) {
				case 'normal':
					echo 'font-weight:normal;';
				break;
				case 'italic':
...
h6 {
	...
	<?php
		if( isset ( $data['h6_typo']['style'] ) ){
			switch ($data['h6_typo']['style']) {
				case 'normal':
					echo 'font-weight:normal;';
				break;
				case 'italic':
