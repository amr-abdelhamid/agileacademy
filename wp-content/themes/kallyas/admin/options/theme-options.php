...
if ( !empty ( $data['zn_mainmenu_color'] ) ) { $menu_color = $data['zn_mainmenu_color'];  }
		...
		*			Start TOP HEADER OPTIONS
		...
		$zn_options[] = array( 
			...
			"id" => "zn_header_layout",
			"std" => "style2",
			"options" => array ( 'style1' => 'Style 1' , 'style2' => 'Style 2 (default)' , 'style3' => 'Style 3' , 'style4' => 'Style 4' , 'style5' => 'Style 5' , 'style6' => 'Style 6'  ),
			"type" => "select"
		);
		...
		*			Start COLOR options
		...
		$zn_options[] = array(
			...
			"description" => "Using this feature you can backup or restore your theme options. If you want to restore a backup, please click on the backup name. If you want to delete a backup , press the red x next to the backup",
			"id" => "backup_restore",
